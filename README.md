...
| 4 | Cross-Dataset Transfer Baseline | MambaOut-Tiny | ImageNet-100 300ep checkpoint → CIFAR-100 | 50 | **82.01%** |
...
|---|---|---|---:|---:|
| MambaOut-Tiny | ImageNet-100 300ep checkpoint | CIFAR-100 | 50 | **82.01%** |
...
|---|---:|
| Original MambaOut-Tiny → CIFAR-100 | **82.01%** |
...
然而，此結果仍低於原始 MambaOut-Tiny transfer baseline 的 **82.01%**，因此目前不能證明 ECA 改良能提升跨資料集泛化能力。
...
| Transfer Baseline | MambaOut-Tiny | ImageNet-100 → CIFAR-100 | **82.01%** |
...
4. 在 CIFAR-100 transfer learning 中，MambaOut-Tiny-ECA 達到 **81.83%** Top-1，但仍低於原始 MambaOut-Tiny baseline 的 **82.01%**。
